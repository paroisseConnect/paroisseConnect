...
@RestController
@RequestMapping("/api/unites-ecclesiales")
@Tag(name = "Unites ecclesiales")
public class UniteEcclesialeController {

	private final UniteEcclesialeService service;

	public UniteEcclesialeController(UniteEcclesialeService service) {
		this.service = service;
	}

	@GetMapping
	@Operation(summary = "Lister les unites ecclesiales")
	public List<UniteEcclesiale> list() {
		return service.listAll();
	}

	@GetMapping("/{code}")
	@Operation(summary = "Detail d'une unite ecclesiale")
